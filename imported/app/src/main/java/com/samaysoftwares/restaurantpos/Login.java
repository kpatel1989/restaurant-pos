...
public class Login extends Activity {
	...
	class LoginTask extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				Log.d("url" , "http://"+ info.getIP()+ "/android_custlogin.php?login="+id+"&password="+pass);
				response = httpclient.execute(new HttpGet("http://"+ info.getIP()+ "/android_custlogin.php?login="+id+"&password="+pass));
